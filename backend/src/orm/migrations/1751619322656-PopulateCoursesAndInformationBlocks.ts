...
export class PopulateCoursesAndInformationBlocks1751619322656 implements MigrationInterface {
    ...
    await queryRunner.query(`
      INSERT INTO information_blocks (name, description, tegs, test_numbers, lecture_numbers, lab_numbers) VALUES
      ('Введение в алгоритмы, асимптотика и анализ', 'Понимание и анализ алгоритмов, их асимптотика.', '{"алгоритмы", "основы"}', '{3,5}', '{1,2,4}', '{}'),
      ('Рекурсия и алгоритмы сортировки', 'Изучение различных сортировок данных и понятие о рекурсии.', '{"алгоритмы", "основы", "сортировки", "программирование"}', '{4,9,12,13}', '{1,5,7,10}', '{2,3,6,8,11}'),
      ('Динамические структуры и алгоритмы их обработки', 'Изучение различных динамических структур, алгоритмов их обработки и способов использования.', '{"алгоритмы", "основы", "структуры данных", "программирование"}', '{11}', '{1,3,5,7,9}', '{2,4,6,8,10}'),
      ('Жадные алгоритмы и динамическое программирование', 'Объяснение "жадных алгоритмов" и изучение методов динамического программирования.', '{"алгоритмы", "основы", "программирование"}', '{2,4,13}', '{1,3,5,7,9,11}', '{6,8,10,12}'),
      ('Хеш-таблицы, хеш-функции и их применение', 'Изучение хеширования и его применения в алгоритмах.', '{"алгоритмы", "основы", "хеширование", "программирование"}', '{2,4,9}', '{1,3,5,7}', '{6,8}'),
      ('Основы алгоритмов на графах и деревьях', 'Изучение алгоритмов на графах и методов работы с ними.', '{"алгоритмы", "основы", "графы"}', '{2,4,9}', '{1,3,5,7}', '{6,8}'),
      ('Куча, пирамидальная сортировка и декартово дерево поиска', 'Понятие о куче, пирамидальной сортировке и декартовом дереве, а так же способах их применения.', '{"алгоритмы", "основы", "сортировки", "графы", "программирование"}', '{2,4,7,10,12}', '{1,3,6,9}', '{5,8,11}'),
      ('Алгоритмы балансировки деревьев поиска', 'Изучение методов балансировки деревьев поиска.', '{"алгоритмы", "основы", "графы", "программирование"}', '{2,4,6,9}', '{1,3,5,7}', '{8}');
    `);
